...
public class SortMenu {
	public void menu() {
		...
		if (choice == 1) {
			...
			Scanner scanQSAsc = new Scanner(System.in);
			System.out.println("Enter the size of the array (number of elements)");
			int size = scanQSAsc.nextInt();
			int[] arr = new int[size];
			for (int i = 0; i < size; i++) {
				System.out.println("Enter the elements one by one");
				arr[i] = scanQSAsc.nextInt();
			}
			...
			Scanner scanQSDesc = new Scanner(System.in);
			System.out.println("Enter the size of the array (number of elements)");
			int size = scanQSDesc.nextInt();
			int[] arr = new int[size];
			for (int i = 0; i < size; i++) {
				System.out.println("Enter the elements one by one");
				arr[i] = scanQSDesc.nextInt();
			}
			int length = arr.length;
			System.out.println("Disorganized array: ");
			disorganizedArray.printArray(arr, length);
