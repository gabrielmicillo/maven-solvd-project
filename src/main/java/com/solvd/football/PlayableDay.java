...
public enum PlayableDay {
	WEDNESDAY("Wednesday", 4, "Dark", 10),
	SATURDAY("Saturday", 8, "Sun", 15),
	SUNDAY("Sunday", 8, "Sun", 20);
	...
	public String toString() {
		return "PlayableDay[" + "dayName= " + dayName + ", playableHours= " + playableHours + ", dayLight= " + dayLight + ", quantityOfMatches= " + quantityOfMatches + "]";
	}
}
